...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '阿北', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '捡垃圾大王', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://etf.125520.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ETF,投资,理财', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '垃圾堆里捡宝藏', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '金融,投资,理财', // 站点描述，被notion中的页面描述覆盖
