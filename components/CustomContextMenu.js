        ...
        >
            ...
            <div className='rounded-xl w-52 dark:hover:border-yellow-600 bg-white dark:bg-[#040404] dark:text-gray-200 dark:border-gray-600 p-3 border drop-shadow-lg flex-col duration-300 transition-colors'>
                ...
                <div className='w-full px-2'>
                    ...
                    {/* {JSON.parse(siteConfig('THEME_SWITCH')) && <div onClick={handeChangeTheme} title={locale.MENU.THEME_SWITCH} className='w-full px-2 h-10 flex justify-start items-center flex-nowrap cursor-pointer hover:bg-blue-600 hover:text-white rounded-lg duration-200 transition-all'><i className="fa-solid fa-palette mr-2" /><div className='whitespace-nowrap'>{locale.MENU.THEME_SWITCH}</div></div>} */}
                    {JSON.parse(siteConfig('THEME_SWITCH')) && <div onClick={handeChangeTheme} title={locale.MENU.THEME_SWITCH} className='w-full px-2 h-10 flex justify-start items-center flex-nowrap cursor-pointer hover:bg-blue-600 hover:text-white rounded-lg duration-200 transition-all'>
